...
jsonSource_LapakGIScomBatas_Kecamatan_BIG_PPBW_0.addFeatures(features_LapakGIScomBatas_Kecamatan_BIG_PPBW_0);var lyr_LapakGIScomBatas_Kecamatan_BIG_PPBW_0 = new ol.layer.Vector({
    ...
    <img src="styles/legend/LapakGIScomBatas_Kecamatan_BIG_PPBW_0_21.png" /> <br />'
        });var format_polsek_1 = new ol.format.GeoJSON();
var features_polsek_1 = format_polsek_1.readFeatures(json_polsek_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_polsek_1 = new ol.source.Vector({
    attributions: [new ol.Attribution({html: '<a href=""></a>'})],
});
jsonSource_polsek_1.addFeatures(features_polsek_1);var lyr_polsek_1 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_polsek_1, 
                style: style_polsek_1,
                title: '<img src="styles/legend/polsek_1.png" /> polsek'
            });

lyr_LapakGIScomBatas_Kecamatan_BIG_PPBW_0.setVisible(true);lyr_polsek_1.setVisible(true);
var layersList = [baseLayer,lyr_LapakGIScomBatas_Kecamatan_BIG_PPBW_0,lyr_polsek_1];
...
lyr_polsek_1.set('fieldAliases', {'Polsek': 'Polsek', });
...
lyr_polsek_1.set('fieldImages', {'Polsek': 'TextEdit', });
lyr_LapakGIScomBatas_Kecamatan_BIG_PPBW_0.set('fieldLabels', {'OBJECTID': 'inline label', 'METADATA': 'inline label', 'SRS_ID': 'inline label', 'WADMKC': 'inline label', 'WADMKK': 'inline label', 'WADMPR': 'inline label', '2018': 'no label', '2019': 'no label', '2020': 'no label', });
lyr_polsek_1.set('fieldLabels', {'Polsek': 'no label', });
lyr_polsek_1.on('precompose', function(evt) {
