...
lyr_LapakGIScomBatas_Kecamatan_BIG_PPBW_0.set('fieldLabels', {'OBJECTID': 'inline label', 'METADATA': 'inline label', 'SRS_ID': 'no label', 'WADMKC': 'inline label', 'WADMKK': 'inline label', 'WADMPR': 'header label', '2018': 'inline label', '2019': 'no label', '2020': 'no label', });
